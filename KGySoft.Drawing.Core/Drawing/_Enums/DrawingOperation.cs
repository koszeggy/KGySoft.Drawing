...
{
    /// <summary>
    /// Represents various drawing operations to indicate the current operation when reporting progress using an <a href="https://docs.kgysoft.net/corelibraries/?topic=html/T_KGySoft_Threading_IAsyncProgress.htm" target="_blank">IAsyncProgress</a> implementation.
    /// This library always uses the <see cref="DrawingOperation"/> type as a type argument when calling the <a href="https://docs.kgysoft.net/corelibraries/?topic=html/M_KGySoft_Threading_IAsyncProgress_New__1.htm" target="_blank">New&lt;T>(T, int, int)</a> method.
    /// </summary>
