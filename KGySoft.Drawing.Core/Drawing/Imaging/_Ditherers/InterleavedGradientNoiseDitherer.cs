...
namespace KGySoft.Drawing.Imaging
{
    ...
    /// <div style="display: none;"><br/>See the <a href="https://koszeggy.github.io/docs/drawing/html/T_KGySoft_Drawing_Imaging_InterleavedGradientNoiseDitherer.htm">online help</a> for image examples.</div>
    /// </summary>
    /// <remarks>
    ...
    /// <br/>Quantizing with <see cref="PredefinedColorsQuantizer.SystemDefault8BppPalette(Color32,byte)">system default 8 BPP palette</see> and interleaved gradient noise dithering</para></div></td>
    /// </tr>
    /// <tr><td><div style="text-align:center;">
    ...
    /// <br/>Quantizing with <see cref="PredefinedColorsQuantizer.BlackAndWhite(Color32,byte,byte)">black and white palette</see> and interleaved gradient noise dithering</para></div></td>
    /// </tr>
    /// </tbody></table></para>
    /// </example>
    ...
    public sealed class InterleavedGradientNoiseDitherer : IDitherer
    {
        ...
        /// <div style="display: none;"><br/>See the <a href="https://koszeggy.github.io/docs/drawing/html/M_KGySoft_Drawing_Imaging_InterleavedGradientNoiseDitherer__ctor_1.htm">online help</a> for an example with images.</div>
        /// </summary>
