...
namespace KGySoft.Drawing.Imaging
{
    ...
    internal sealed class BitmapDataWrapper : IBitmapDataInternal
    {
        ...
        private sealed class BitmapDataRowWrapper : IBitmapDataRowInternal
        {
            ...
            [SecurityCritical]public Color32 DoGetColor32(int x) => readableBitmapDataRow.GetColor32(x);
            [SecurityCritical]public void DoSetColor32(int x, Color32 c) => writableBitmapDataRow.SetColor32(x, c);
            [SecurityCritical]public PColor32 DoGetPColor32(int x) => readableBitmapDataRow.GetPColor32(x);
            [SecurityCritical]public void DoSetPColor32(int x, PColor32 c) => writableBitmapDataRow.SetPColor32(x, c);
            [SecurityCritical]public Color64 DoGetColor64(int x) => readableBitmapDataRow.GetColor64(x);
            [SecurityCritical]public void DoSetColor64(int x, Color64 c) => writableBitmapDataRow.SetColor64(x, c);
            [SecurityCritical]public PColor64 DoGetPColor64(int x) => readableBitmapDataRow.GetPColor64(x);
            [SecurityCritical]public void DoSetPColor64(int x, PColor64 c) => writableBitmapDataRow.SetPColor64(x, c);
            [SecurityCritical]public ColorF DoGetColorF(int x) => readableBitmapDataRow.GetColorF(x);
            [SecurityCritical]public void DoSetColorF(int x, ColorF c) => writableBitmapDataRow.SetColorF(x, c);
            [SecurityCritical]public PColorF DoGetPColorF(int x) => readableBitmapDataRow.GetPColorF(x);
            [SecurityCritical]public void DoSetPColorF(int x, PColorF c) => writableBitmapDataRow.SetPColorF(x, c);
            [SecurityCritical]public int DoGetColorIndex(int x) => readableBitmapDataRow.GetColorIndex(x);
            [SecurityCritical]public void DoSetColorIndex(int x, int colorIndex) => writableBitmapDataRow.SetColorIndex(x, colorIndex);
        ...
        [SecurityCritical]public Color32 DoGetColor32(int x, int y) => AsReadable.GetColor32(x, y);
        [SecurityCritical]public void DoSetColor32(int x, int y, Color32 color) => AsWritable.SetColor32(x, y, color);
        [SecurityCritical]public PColor32 DoGetPColor32(int x, int y) => AsReadable.GetPColor32(x, y);
        [SecurityCritical]public void DoSetPColor32(int x, int y, PColor32 color) => AsWritable.SetPColor32(x, y, color);
        [SecurityCritical]public Color64 DoGetColor64(int x, int y) => AsReadable.GetColor64(x, y);
        [SecurityCritical]public void DoSetColor64(int x, int y, Color64 color) => AsWritable.SetColor64(x, y, color);
        [SecurityCritical]public PColor64 DoGetPColor64(int x, int y) => AsReadable.GetPColor64(x, y);
        [SecurityCritical]public void DoSetPColor64(int x, int y, PColor64 color) => AsWritable.SetPColor64(x, y, color);
        [SecurityCritical]public ColorF DoGetColorF(int x, int y) => AsReadable.GetColorF(x, y);
        [SecurityCritical]public void DoSetColorF(int x, int y, ColorF color) => AsWritable.SetColorF(x, y, color);
        [SecurityCritical]public PColorF DoGetPColorF(int x, int y) => AsReadable.GetPColorF(x, y);
        [SecurityCritical]public void DoSetPColorF(int x, int y, PColorF color) => AsWritable.SetPColorF(x, y, color);
        ...
        [SecurityCritical]public int DoGetColorIndex(int x, int y) => AsReadable.GetColorIndex(x, y);
        [SecurityCritical]public void DoSetColorIndex(int x, int y, int colorIndex) => AsWritable.SetColorIndex(x, y, colorIndex);
