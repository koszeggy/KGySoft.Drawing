...
{
    internal sealed class ManagedBitmapData8Gray : ManagedBitmapData1DArrayBase<Gray8, ManagedBitmapData8Gray.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataRowBase<Gray8>
        {
            #region Methods
