    ...
    internal sealed class ManagedBitmapData32Rgb : ManagedBitmapData1DArrayBase<Color32, ManagedBitmapData32Rgb.Row>
    {
        ...
        internal sealed class Row : ManagedBitmapDataRowBase<Color32>
        {
            ...
            public override void DoSetColor32(int x, Color32 c)
                => Row[x] = c.A == Byte.MaxValue ? c : c.BlendWithBackground(BitmapData.BackColor, BitmapData.LinearWorkingColorSpace);

            [MethodImpl(MethodImpl.AggressiveInlining)]
            public override void DoSetColorF(int x, ColorF c) => Row[x] = c.A >= 1f ? c.ToColor32()
