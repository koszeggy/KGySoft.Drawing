...
namespace KGySoft.Drawing.Imaging
{
    internal sealed class ManagedBitmapData96Rgb : ManagedBitmapData1DArrayBase<RgbF, ManagedBitmapData96Rgb.Row>
    {
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override PColor64 DoGetPColor64(int x, int y) => Buffer[y, x].ToColor64().ToPColor64();
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override PColorF DoGetPColorF(int x, int y) => Buffer[y, x].ToColorF().ToPColorF();
