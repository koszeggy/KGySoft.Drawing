    ...
    internal sealed class ManagedBitmapData16Rgb555 : ManagedBitmapData1DArrayBase<Color16Rgb555, ManagedBitmapData16Rgb555.Row>
    {
        ...
        internal sealed class Row : ManagedBitmapDataRowBase<Color16Rgb555>
        {
            ...
            public override void DoSetColor32(int x, Color32 c)
                => Row[x] = new Color16Rgb555(c.A == Byte.MaxValue ? c : c.BlendWithBackground(BitmapData.BackColor, BitmapData.LinearWorkingColorSpace));
        ...
        protected override void DoSetColor32(int x, int y, Color32 c)
            => Buffer[y, x] = new Color16Rgb555(c.A == Byte.MaxValue ? c : c.BlendWithBackground(BackColor, LinearWorkingColorSpace));
