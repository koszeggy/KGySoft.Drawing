    ...
    internal sealed class ManagedBitmapData16Gray : ManagedBitmapData1DArrayBase<Color16Gray, ManagedBitmapData16Gray.Row>
    {
        ...
        internal sealed class Row : ManagedBitmapDataRowBase<Color16Gray>
        {
            ...
            public override void DoSetColor64(int x, Color64 c) => Row[x] = BitmapData.LinearWorkingColorSpace
                ...
                : new Color16Gray(c.A == UInt16.MaxValue ? c : c.BlendWithBackgroundSrgb(((ManagedBitmapData16Gray)BitmapData).backColor64));
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override void DoSetColor64(int x, int y, Color64 c) => Buffer[y, x] = LinearWorkingColorSpace
