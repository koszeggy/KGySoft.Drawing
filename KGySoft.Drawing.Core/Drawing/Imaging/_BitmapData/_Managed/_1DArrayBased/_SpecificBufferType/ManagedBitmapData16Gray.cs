...
{
    internal sealed class ManagedBitmapData16Gray : ManagedBitmapData1DArrayBase<Gray16, ManagedBitmapData16Gray.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataRowBase<Gray16>
        {
            #region Methods
