...
namespace KGySoft.Drawing.Imaging
{
    internal sealed class ManagedBitmapData24Rgb : ManagedBitmapData1DArrayBase<Color24, ManagedBitmapData24Rgb.Row>
    {
        ...
        internal sealed class Row : ManagedBitmapDataRowBase<Color24>
        {
            ...
            [MethodImpl(MethodImpl.AggressiveInlining)]
            public override void DoSetColorF(int x, ColorF c) => Row[x] = new Color24(c.A >= 1f ? c.ToColor32()
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        public override void DoSetColorF(int x, int y, ColorF c) => Buffer[y, x] = new Color24(c.A >= 1f ? c.ToColor32()
