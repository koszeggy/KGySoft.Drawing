...
{
    internal sealed class ManagedBitmapData96Rgb : ManagedBitmapDataArray2DBase<RgbF, ManagedBitmapData96Rgb.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataArraySectionRowBase<RgbF>
        {
            #region Methods
