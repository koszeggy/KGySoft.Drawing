...
{
    internal sealed class ManagedBitmapData128Rgba : ManagedBitmapDataArray2DBase<ColorF, ManagedBitmapData128Rgba.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataArraySectionRowBase<ColorF>
        {
            #region Methods
