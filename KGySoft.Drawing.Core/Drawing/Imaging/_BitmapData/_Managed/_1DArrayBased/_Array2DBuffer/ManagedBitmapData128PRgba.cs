...
{
    internal sealed class ManagedBitmapData128PRgba : ManagedBitmapDataArray2DBase<PColorF, ManagedBitmapData128PRgba.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataArraySectionRowBase<PColorF>
        {
            #region Methods
