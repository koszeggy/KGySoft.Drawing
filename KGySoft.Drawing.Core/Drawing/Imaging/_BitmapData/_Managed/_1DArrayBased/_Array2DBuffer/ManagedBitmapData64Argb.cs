...
{
    internal sealed class ManagedBitmapData64Argb : ManagedBitmapDataArray2DBase<Color64, ManagedBitmapData64Argb.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataArraySectionRowBase<Color64>
        {
            #region Methods
