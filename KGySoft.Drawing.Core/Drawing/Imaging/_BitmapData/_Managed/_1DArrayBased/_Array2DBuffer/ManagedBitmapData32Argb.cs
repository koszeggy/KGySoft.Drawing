...
{
    internal sealed class ManagedBitmapData32Argb : ManagedBitmapDataArray2DBase<Color32, ManagedBitmapData32Argb.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataArraySectionRowBase<Color32>
        {
            #region Methods
