...
{
    internal sealed class ManagedBitmapData32PArgb : ManagedBitmapDataArray2DBase<PColor32, ManagedBitmapData32PArgb.Row>
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataArraySectionRowBase<PColor32>
        {
            #region Methods
