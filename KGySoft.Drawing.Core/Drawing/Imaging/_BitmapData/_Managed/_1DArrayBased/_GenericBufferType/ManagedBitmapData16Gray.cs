        ...
        where T : unmanaged
    {
        ...
        internal sealed class Row : ManagedBitmapDataRowBase<T>
        {
            ...
            public override void DoSetColor32(int x, Color32 c)
                => DoWriteRaw(x, new Color16Gray(c.A == Byte.MaxValue ? c : c.BlendWithBackground(BitmapData.BackColor, BitmapData.PrefersLinearBlending)));
        ...
        protected override void DoSetPixel(int x, int y, Color32 c)
            => GetPixelRef<Color16Gray>(y, x) = new Color16Gray(c.A == Byte.MaxValue ? c : c.BlendWithBackground(BackColor, PrefersLinearBlending));
