...
{
    internal sealed class ManagedBitmapData8Gray<T> : ManagedBitmapData1DArrayBase<T, ManagedBitmapData8Gray<T>.Row>
        where T : unmanaged
    {
        #region Row class
        ...
        internal ManagedBitmapData8Gray(Array2D<T> buffer, in BitmapDataConfig cfg)
            : base(buffer, cfg)
        {
        }
