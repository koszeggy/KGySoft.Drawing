...
{
    internal sealed class ManagedBitmapData32Gray<T> : ManagedBitmapData1DArrayBase<T, ManagedBitmapData32Gray<T>.Row>
        where T : unmanaged
    {
        #region Row class
        ...
        internal sealed class Row : ManagedBitmapDataRowBase<T>
        {
            ...
            public override void DoSetColor32(int x, Color32 c) => DoWriteRaw(x, BitmapData.LinearWorkingColorSpace
                ? new GrayF(c.A == Byte.MaxValue ? c.ToColorF() : c.ToColorF().BlendWithBackgroundLinear(((ManagedBitmapData32Gray<T>)BitmapData).backColorF))
            ...
            public override void DoSetColor64(int x, Color64 c) => DoWriteRaw(x, BitmapData.LinearWorkingColorSpace
                ? new GrayF(c.A == UInt16.MaxValue ? c.ToColorF() : c.ToColorF().BlendWithBackgroundLinear(((ManagedBitmapData32Gray<T>)BitmapData).backColorF))
            ...
            public override void DoSetColorF(int x, ColorF c) => DoWriteRaw(x, BitmapData.LinearWorkingColorSpace
                ? new GrayF(c.A >= 1f ? c : c.BlendWithBackgroundLinear(((ManagedBitmapData32Gray<T>)BitmapData).backColorF))
        ...
        internal ManagedBitmapData32Gray(Array2D<T> buffer, in BitmapDataConfig cfg)
            : base(buffer, cfg)
        {
            backColorF = BackColor.ToColorF();
        }
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override Color32 DoGetColor32(int x, int y) => GetPixelRef<GrayF>(y, x).ToColor32();

        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override void DoSetColor32(int x, int y, Color32 c) => GetPixelRef<GrayF>(y, x) = LinearWorkingColorSpace
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override Color64 DoGetColor64(int x, int y) => GetPixelRef<GrayF>(y, x).ToColor64();

        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override void DoSetColor64(int x, int y, Color64 c) => GetPixelRef<GrayF>(y, x) = LinearWorkingColorSpace
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override PColor64 DoGetPColor64(int x, int y) => PColor64.FromArgb(GetPixelRef<GrayF>(y, x).ToColor64().ToArgbUInt64());
        ...
        [MethodImpl(MethodImpl.AggressiveInlining)]
        protected override PColorF DoGetPColorF(int x, int y) => GetPixelRef<GrayF>(y, x).ToColorF().ToPColorF();
