...
{
    internal sealed class ManagedBitmapData32Gray<T> : ManagedBitmapDataCastArray2DBase<T, GrayF, ManagedBitmapData32Gray<T>.Row>
        where T : unmanaged
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataCastArrayRowBase<T, GrayF>
        {
            #region Methods
        ...
        internal ManagedBitmapData32Gray(CastArray2D<T, GrayF> buffer, in BitmapDataConfig cfg)
            : base(buffer, cfg)
        {
            backColorF = BackColor.ToColorF();
        }
