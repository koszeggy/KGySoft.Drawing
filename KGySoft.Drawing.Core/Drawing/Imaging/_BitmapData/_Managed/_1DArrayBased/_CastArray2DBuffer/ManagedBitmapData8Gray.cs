...
{
    internal sealed class ManagedBitmapData8Gray<T> : ManagedBitmapDataCastArray2DBase<T, Gray8, ManagedBitmapData8Gray<T>.Row>
        where T : unmanaged
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataCastArrayRowBase<T, Gray8>
        {
            #region Methods
        ...
        internal ManagedBitmapData8Gray(CastArray2D<T, Gray8> buffer, in BitmapDataConfig cfg)
            : base(buffer, cfg)
        {
        }
