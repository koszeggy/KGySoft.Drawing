...
{
    internal sealed class ManagedBitmapData64PArgb<T> : ManagedBitmapDataCastArray2DBase<T, PColor64, ManagedBitmapData64PArgb<T>.Row>
        where T : unmanaged
    {
        #region Row class

        internal sealed class Row : ManagedBitmapDataCastArrayRowBase<T, PColor64>
        {
            #region Methods
        ...
        internal ManagedBitmapData64PArgb(CastArray2D<T, PColor64> buffer, in BitmapDataConfig cfg)
            : base(buffer, cfg)
        {
        }
