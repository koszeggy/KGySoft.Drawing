    ...
    internal sealed class UnmanagedBitmapData16Rgb565 : UnmanagedBitmapDataBase<UnmanagedBitmapData16Rgb565.Row>
    {
        ...
        internal sealed class Row : UnmanagedBitmapDataRowBase
        {
            ...
            public override unsafe void DoSetColor32(int x, Color32 c)
                => ((Color16Rgb565*)Row)[x] = new Color16Rgb565(c.A == Byte.MaxValue ? c : c.BlendWithBackground(BitmapData.BackColor, BitmapData.LinearBlending));
        ...
        protected override unsafe void DoSetPixel(int x, int y, Color32 c)
            => *GetPixelAddress<Color16Rgb565>(y, x) = new Color16Rgb565(c.A == Byte.MaxValue ? c : c.BlendWithBackground(BackColor, LinearBlending));
