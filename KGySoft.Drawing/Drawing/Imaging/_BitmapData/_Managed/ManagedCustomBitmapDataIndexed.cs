...
{
    internal sealed class ManagedCustomBitmapDataIndexed<T> : ManagedBitmapDataSingleArrayBased<T>
        where T : unmanaged
    {
        ...
        public unsafe ManagedCustomBitmapDataIndexed(Array2D<T> buffer, int pixelWidth, PixelFormat pixelFormat,
            ...
            : base(new Size(pixelWidth, buffer.Height), pixelFormat, palette?.BackColor ?? default, palette?.AlphaThreshold ?? 128, palette, setPalette, disposeCallback)
        {
