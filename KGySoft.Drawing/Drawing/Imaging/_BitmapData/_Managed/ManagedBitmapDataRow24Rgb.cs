...
{
    internal sealed class ManagedBitmapDataRow24Rgb : ManagedBitmapDataRowBase<Color24>
    {
        #region Methods
    ...
    internal sealed class ManagedBitmapDataRow24Rgb2D<T> : ManagedBitmapDataRow2DBase<T>
        where T : unmanaged
    {
        #region Methods
