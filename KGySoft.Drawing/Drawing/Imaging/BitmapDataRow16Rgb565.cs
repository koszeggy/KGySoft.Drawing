...
{
    internal sealed class BitmapDataRow16Rgb565 : BitmapDataRowNoAlphaBase
    {
        #region Methods
        ...
        internal override unsafe void DoSetColor32(int x, Color32 c)
            => ((Color16Rgb565*)Address)[x] = new Color16Rgb565(c.A == Byte.MaxValue ? c : c.BlendWithBackground(BackColor));
