...
namespace KGySoft.Drawing.Examples.WinUI.ViewModel
{
    internal class MainViewModel : ObservableObjectBase
    {
        ...
        public Microsoft.UI.Xaml.Media.Brush? OutlineColorBrush { get => Get<Microsoft.UI.Xaml.Media.Brush?>(() => new SolidColorBrush(OutlineColor)); set => Set(value); }
        ...
        public Microsoft.UI.Xaml.Media.Brush? BackColorBrush { get => Get<Microsoft.UI.Xaml.Media.Brush?>(() => new SolidColorBrush(BackColor)); set => Set(value); }
        ...
        private static async Task<WriteableBitmap> LoadResourceBitmap(string fileName)
        {
            ...
            await using Stream pixelStream = result.PixelBuffer.AsStream();
