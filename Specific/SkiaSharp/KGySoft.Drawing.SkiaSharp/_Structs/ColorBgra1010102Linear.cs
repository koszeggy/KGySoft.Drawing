...
///////////////////////////////////////////////////////////////////////////////
//  File: ColorBgra1010102Linear.cs
///////////////////////////////////////////////////////////////////////////////
...
{
    internal readonly struct ColorBgra1010102Linear
    {
        #region Constants
        ...
        internal ColorBgra1010102Linear(Color32 c)
            : this(new Color64(c))
        {
        }

        internal ColorBgra1010102Linear(Color64 c) => Value =
            ((uint)(c.A >> 14) << 30)
            | (uint)((c.R.ToLinear() >> 6) << 20)
            | (uint)((c.G.ToLinear() >> 6) << 10)
            | (uint)(c.B.ToLinear() >> 6);

        internal ColorBgra1010102Linear(ColorF c)
        {
