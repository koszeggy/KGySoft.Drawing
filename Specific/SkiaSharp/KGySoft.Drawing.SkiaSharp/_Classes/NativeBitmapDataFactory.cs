...
namespace KGySoft.Drawing.SkiaSharp
{
    internal static class NativeBitmapDataFactory
    {
        ...
        internal static bool TryCreateBitmapData(IntPtr buffer, SKImageInfo info, int stride, SKColor backColor, byte alphaThreshold, Action? disposeCallback, [MaybeNullWhen(false)] out IReadWriteBitmapData bitmapData)
        {
            info.GetDirectlySupportedColorSpace(out bool srgb, out bool linear);
            bitmapData = srgb ? CreateBitmapDataSrgb(buffer, info, stride, backColor, alphaThreshold, disposeCallback)
        ...
        private static IReadWriteBitmapData CreateBitmapDataSrgb(IntPtr buffer, SKImageInfo info, int stride, SKColor backColor, byte alphaThreshold, Action? disposeCallback = null)
        {
        ...
        private static IReadWriteBitmapData CreateBitmapDataLinear(IntPtr buffer, SKImageInfo info, int stride, SKColor backColor, byte alphaThreshold, Action? disposeCallback = null)
        {
