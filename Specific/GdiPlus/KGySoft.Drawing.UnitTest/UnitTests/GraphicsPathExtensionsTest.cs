...
namespace KGySoft.Drawing.UnitTests
{
    ...
    public class GraphicsPathExtensionsTest : TestBase
    {
        ...
        [
            ...
            ["Point-horizontal flat arc-point", new Builder().AddLines([new(50, 0)]).AddArc(new (0, 50, 100, 1e-5f), 45, 300).AddLines([new(50, 100)]).Path],
            ["Point-vertical arc-point", new Builder().AddLines([new(0, 50)]).AddArc(new (50, 0, 20, 100), 45, 300).AddLines([new(100, 50)]).Path],
            ["Point-vertical flat arc-point", new Builder().AddLines([new(0, 50)]).AddArc(new(50, 0, 1e-5f, 100), 45, 300).AddLines([new(100, 50)]).Path],
