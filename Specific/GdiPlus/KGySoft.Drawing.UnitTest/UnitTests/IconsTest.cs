...
namespace KGySoft.Drawing.UnitTests
{
    ...
    public class IconsTest : TestBase
    {
        ...
        private static object[][] SourceKnownIconsTest => new[]
        {
            ...
            new object[] { nameof(Icons.SystemSecuritySuccess), Icons.SystemSecuritySuccess },
            new object[] { nameof(Icons.SystemSecurityWarning), Icons.SystemSecurityWarning },
            new object[] { nameof(Icons.SystemSecurityQuestion), Icons.SystemSecurityQuestion },
