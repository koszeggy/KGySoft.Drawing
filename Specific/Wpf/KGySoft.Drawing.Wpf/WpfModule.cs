...
{
    /// <summary>
    /// Represents the <c>KGySoft.Drawing.Wpf</c> module.
    ...
    public static class WpfModule
    {
        ...
        /// </remarks>
        /// <example>
        /// The following example demonstrates how to initialize the <c>KGySoft.Drawing.Wpf</c> module in an application (you don't really need to do this
        /// if you use KGy SOFT Drawing WPF Libraries from a class library):
        /// <code lang="C#"><![CDATA[
        /// using KGySoft;
