    ...
    public class BitmapExtensionsTest : TestBase
    {
        ...
        public void BatchDitherTest(string testName, IQuantizer quantizer, int maxColors)
        {
            ...
            (IDitherer Ditherer, string Name)[] ditherers =
            {
                ...
                (OrderedDitherer.Bayer2x2(), nameof(OrderedDitherer.Bayer2x2)),
                //(OrderedDitherer2.Bayer3x3(), nameof(OrderedDitherer2.Bayer3x3)),
                //(OrderedDitherer2.Bayer4x4(), nameof(OrderedDitherer2.Bayer4x4)),
                (OrderedDitherer.Bayer8x8(), nameof(OrderedDitherer.Bayer8x8)),
                //(OrderedDitherer2.Halftone5(), nameof(OrderedDitherer2.Halftone5)),
                //(OrderedDitherer2.Halftone7(), nameof(OrderedDitherer2.Halftone7)),
                (OrderedDitherer.BlueNoise64x64(), nameof(OrderedDitherer.BlueNoise64x64)),
                //(OrderedDitherer2.BlueNoise(new Size(256, 256)), nameof(OrderedDitherer2.BlueNoise)),                //(ErrorDiffusionDitherer.FloydSteinberg, nameof(ErrorDiffusionDitherer.FloydSteinberg)),
