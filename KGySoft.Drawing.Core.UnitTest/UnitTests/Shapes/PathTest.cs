...
namespace KGySoft.Drawing.UnitTests.Shapes
{
    ...
    public class PathTest : TestBase
    {
        ...
        [
            ...
            ["Quadratic Bezier", new Path().AddQuad(new(0, 100), new(0, 50), new(100, 100)), 1f],
            ["Conic curve w=1", new Path().AddConic(new(0, 100), new(50, 0), new(100, 100), 1f), 1f],
            ["Conic curve w=0.5", new Path().AddConic(new(0, 100), new(50, 0), new(100, 100), 0.5f), 1f],
            ["Conic curve w=2", new Path().AddConic(new(0, 100), new(50, 0), new(100, 100), 2f), 1f],
